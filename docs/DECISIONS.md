...
| STRATA-D048 | Clear-all is a receipt-governed SQLite sediment operation plus provisional-idle reset, never committed-ledger deletion. Active, empty sediment, affected daily contributions, and checkpoint state publish atomically. | implemented and certified |
