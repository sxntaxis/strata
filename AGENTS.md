...
- Do not combine governance work with unrelated runtime changes.
...
- A completed migration or work unit must be reflected in the owning Notebook frontier before the next program begins.

## Verification

For application changes, run the commands declared in `project.meta.toml`.
