...
updated: 2026-09-04
authority: working
summary: H4/v5 remains published production authority and SEDIMENT-008 oslo-vessel-front physics remains owner-frozen. SEDIMENT-014R3 is machine-green but owner human rainbow evidence rejects aggregate weighted-parcel transport: mass/custody are correct while CategoryId transit and downstream color progression remain visually implausible. SEDIMENT-015A therefore opens a sibling unit-carrier experiment: compact settled columns plus one ephemeral visual carrier per active/pending mass unit, replaying only observed physical edges and reconciling exact stack order.
next: Natively validate SEDIMENT-015A as a machine/semantic foundation on top of the certified R3 mechanical head. Require clean integration, frozen-front parity, per-unit/category conservation, no future-edge prediction, MotionId re-entry continuity, exact ordered stack drain, wall-failure concurrency, resize round-trip custody, legacy conservative regressions, and full repository gates. Human aesthetic acceptance waits for SEDIMENT-015B local-separation microdynamics.
---
